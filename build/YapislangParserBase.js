...
import YapislangParser from '../build/YapislangParser';

export default class YapislangLexerBase extends antlr4.Parser {
    ...
    notLineTerminator() {
        return !this.here(YapislangParser.LineTerminator);
    }
    ...
    closeBrace() {
        return this._input.LT(1).type === YapislangParser.CloseBrace;
    }
    ...
    lineTerminatorAhead() {
        ...
        if (ahead.type === YapislangParser.LineTerminator) {
            return true;
        }
        if (ahead.type === YapislangParser.WhiteSpaces) {
