...
export default class YapislangParser extends YapislangParserBase {
	...
	iterationStatement() {
	    ...
	    try {
	        ...
	        case 1:
	            ...
	            if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << YapislangParser.OpenBracket) | (1 << YapislangParser.OpenParen) | (1 << YapislangParser.OpenBrace) | (1 << YapislangParser.PlusPlus) | (1 << YapislangParser.MinusMinus) | (1 << YapislangParser.Plus) | (1 << YapislangParser.Minus) | (1 << YapislangParser.Not))) !== 0) || ((((_la - 36)) & ~0x1f) == 0 && ((1 << (_la - 36)) & ((1 << (YapislangParser.BooleanLiteral - 36)) | (1 << (YapislangParser.DecimalLiteral - 36)) | (1 << (YapislangParser.Function - 36)) | (1 << (YapislangParser.String - 36)) | (1 << (YapislangParser.StringList - 36)) | (1 << (YapislangParser.Char - 36)) | (1 << (YapislangParser.Int - 36)) | (1 << (YapislangParser.Bool - 36)) | (1 << (YapislangParser.Identifier - 36)) | (1 << (YapislangParser.StringLiteral - 36)))) !== 0)) {
	                this.state = 163;
	                this.expressionSequence();
	            }
	...
	propertyName() {
	    ...
	    try {
	        ...
	        case YapislangParser.String:
	        case YapislangParser.StringList:
	        case YapislangParser.Char:
	        case YapislangParser.Int:
	        case YapislangParser.Bool:
	...
	objectLiteral() {
	    ...
	    try {
	        ...
	        this._errHandler.sync(this);
	        _la = this._input.LA(1);
	        if(_la===YapislangParser.OpenBracket || ((((_la - 36)) & ~0x1f) == 0 && ((1 << (_la - 36)) & ((1 << (YapislangParser.BooleanLiteral - 36)) | (1 << (YapislangParser.DecimalLiteral - 36)) | (1 << (YapislangParser.Else - 36)) | (1 << (YapislangParser.Return - 36)) | (1 << (YapislangParser.For - 36)) | (1 << (YapislangParser.Function - 36)) | (1 << (YapislangParser.If - 36)) | (1 << (YapislangParser.In - 36)) | (1 << (YapislangParser.String - 36)) | (1 << (YapislangParser.StringList - 36)) | (1 << (YapislangParser.Char - 36)) | (1 << (YapislangParser.Int - 36)) | (1 << (YapislangParser.Bool - 36)) | (1 << (YapislangParser.Identifier - 36)) | (1 << (YapislangParser.StringLiteral - 36)))) !== 0)) {
	            this.state = 391;
